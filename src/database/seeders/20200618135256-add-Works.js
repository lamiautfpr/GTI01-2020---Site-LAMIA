      ...
      [
        {
          ...
          date_begin: new Date(2019, 07, 01).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
          code: 'TCC01/2019',
        },
        {
          ...
          date_begin: new Date(2019, 09, 01).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
          code: 'IC01/2019',
        ...
        },
        {
          ...
          date_begin: new Date(2019, 03, 01).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
          code: 'ICT01/2019',
        ...
        },
        {
          ...
          date_begin: new Date(2021, 02, 01).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
          code: 'EXT01/2020',
        },
        {
          ...
          date_begin: new Date(2021, 03, 01).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
          code: 'EXT02/2020',
        },
        {
          ...
          date_begin: new Date(2019, 07, 03).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
          code: 'IC01/2020',
        },
        {
          ...
          git_hub: 'https://github.com/lamiautfpr/ICT01-2019---E-Battle',
          date_begin: new Date(2020, 07, 01).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
          code: 'CLB01-2020',
        ...
        },
        {
          ...
          date_begin: new Date(2018, 09, 01).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
        },
        {
          ...
          date_begin: new Date(2019, 02, 06).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
        },
        {
          ...
          date_begin: new Date(2018, 01, 14).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
        },
        {
          ...
          date_begin: new Date(2018, 07, 08).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
        },
        {
          ...
          date_begin: new Date(2017, 07,01).getTime(),
          created_at: new Date(),
          updated_at: new Date(),
          visible: true,
        },
